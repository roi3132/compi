...
{SETCOLOR}\"{COLOR}\"{CLOSESYMB}								fprintf(yyout, "set_text_color\t\t\t%s\tColor ", yytext);for(int i=13;i<yyleng-2;i++){fprintf(yyout, "%c", yytext[i]);}fprintf(yyout,"\n");
